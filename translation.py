class Translation(object):
    START_TEXT = """Hi!
This Is An APP ID & HASH GENERATOR BOT. I Can Help You Get Your Telegram APP ID & HASH,
...
"""
    BEFORE_SUCC_LOGIN = "Wait please code recieving. Scarpping Web Page..."
    ERRED_PAGE = " Something Went Wrong. Failed To Get App ID.\n\nPlease get support @ShizuUpdates"
    CANCELLED_MESG = "BBye! Please Reply /start the bot conversation"
