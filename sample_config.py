...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "telegramorg")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "telegramorg")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/MyTelegramORG_herobot")
    ...
    # please reopen
    # https://github.com/TeamShizu/TelegramOrgRoBot/issues/3
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/MyTelegramORG_herobot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Managed With ☕️ By @Mr_Rasiyaa")
